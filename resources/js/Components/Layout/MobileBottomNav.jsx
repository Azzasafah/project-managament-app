...
export default function MobileBottomNav({ currentTab, setCurrentTab, navItems }) {
    return (
        <nav className="md:hidden fixed bottom-0 left-0 right-0 glass border-t border-slate-200/80 z-40 px-2 py-1.5 shadow-[0_-4px_20px_rgba(0,0,0,0.05)] font-sans">
